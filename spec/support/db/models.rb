...
class User < ActiveRecord::Base
  ...
  has_many :following_users, -> { where item_type: 'User' }, class_name: 'Follow', foreign_key: 'user_id'
  has_many :follower_users, -> { where item_type: 'User' }, class_name: 'Follow', foreign_key: 'item_id'
